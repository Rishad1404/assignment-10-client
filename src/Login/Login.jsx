                ...
                <div className=" max-w-md p-8 space-y-3 rounded-xl dark:bg-base-200 dark:text-gray-800 md:w-3/4 lg:w-1/2 mx-auto shadow-md">
                    ...
                    <form onSubmit={handleLogin} noValidate="" action="" className="space-y-6">
                        <div className="space-y-1 text-sm">
                            ...
                            <input type="email" name="email" id="username" placeholder="Email" className="w-full px-4 py-3 rounded-md border dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" required />
                        </div>
                        <div className="space-y-1 text-sm">
                        ...
                        <button className="block w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-[#0097B2]">Login</button>
                    </form>

                    <div className="flex items-center pt-4 space-x-1">
                        <div className="flex-1 h-px sm:w-16 dark:bg-gray-300"></div>
                        <p className="px-3 text-md dark:text-gray-600 font-bold">Login with social accounts</p>
                        <div className="flex-1 h-px sm:w-16 dark:bg-gray-300"></div>
                    </div>
                    ...
                    <p className="text-md text-center sm:px-6 dark:text-gray-600">Do not have an account?
                        <Link to='/register' className="underline text-[#0097B2] font-bold">Register</Link>
                    </p>
                </div>
